...
static void test_ajoute_ville(){
    ...
    set_specialite_ville(v3, "Gouda, le seul truc que les hollandais savent faire.");

    Gaule *tour = cree_nouveau_tour(v1, v2);

    ajoute_ville(tour, v3);

    assert_string_equal("Gouda, le seul truc que les hollandais savent faire.", get_specialite(tour, "Brouwersdam"));
